    ...
    public static async Task<List<OfflineSesionItem>> ObtenerSesionesPendientesAsync()
    {
        ...
        while (await reader.ReadAsync())
        {
            var item = new OfflineSesionItem
            {
                ...
                FechaHoraInicio = DateTime.Parse(reader.GetString(4), System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.RoundtripKind).ToUniversalTime(),
                FechaHoraFin = reader.IsDBNull(5) ? null : DateTime.Parse(reader.GetString(5), System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.RoundtripKind).ToUniversalTime(),
